...
for folder in os.listdir(dir):
    ...
    if os.path.isfile(args_path) and os.path.isfile(results_path):
        ...
        res["hsv_h"] = args.get("hsv_h", None)
        res["hsv_s"] = args.get("hsv_s", None)
        res["hsv_v"] = args.get("hsv_v", None)
        res["degrees"] = args.get("degrees", None)
        res["translate"] = args.get("translate", None)
        res["shear"] = args.get("shear", None)
